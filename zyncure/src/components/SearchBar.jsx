...
export default function SearchBar({ userType, className = "" }) {
    ...
    useEffect(() => {
        ...
        setIsLoading(true);
        const searchItems = getSearchItems(userType);
    ...
    return (
        <>
            {/* Desktop Search bar */}
            <div className={`hidden md:block relative w-full max-w-sm ${className}`} ref={searchRef}>
