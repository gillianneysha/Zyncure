...
const AppointmentList = ({ 
  ...
  const handleConfirmRemove = async () => {
    ...
    try {
      ...
      const { error } = await appointmentService.deleteAppointment(appointmentToRemove.id);
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <p className="text-gray-600 mb-6">
              Are you sure you want to remove this appointment from your schedule? This action cannot be undone.
            </p>
            
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              <div className="text-sm">
                <div className="font-medium text-gray-900 mb-1">
                  {appointmentToRemove.time} - {doctors.find(d => d.id === appointmentToRemove.doctor_id)?.name || 'Unknown Doctor'}
                </div>
