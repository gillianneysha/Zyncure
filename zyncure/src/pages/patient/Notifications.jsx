...
import { Bell, Check, CheckCheck, X, User, Calendar, Clock } from "lucide-react";
    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-400 text-sm">You'll see notifications here when you have connection requests or updates</p>
        </div>
      ) : (
        <div className="space-y-3">
          {notifications.map((notif) => (
            <div
              key={notif.id}
              className={`rounded-xl px-6 py-4 border transition-all duration-200 ${getNotificationColor(notif.type, notif.is_read)}`}
            >
              <div className="flex items-start justify-between">
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className={`text-sm ${notif.is_read ? 'text-gray-600' : 'text-gray-800'}`}>
                      {notif.message}
                    </p>
                    ...
                    <div className="flex items-center gap-4 mt-2">
                      ...
                      {notif.metadata && Object.keys(notif.metadata).length > 0 && (
                        <div className="text-xs text-gray-500">
                          {notif.type.includes('connection') && notif.metadata.connection_id && (
