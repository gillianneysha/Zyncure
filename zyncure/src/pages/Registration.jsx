...
export default function Registration() {
    ...
    function handleSubmit(event) {
        ...
        alert(`${activeTab} form submitted! (Implement submission logic)`);
    }
                ...
                {activeTab === 'login' ? (
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="w-4/5 mx-auto text-[#F5E0D9] text-xs text-center mt-6">
                            ...
                            <button type="button" className="flex items-center justify-center w-14 h-14 rounded-full bg-[#FFEDE7] shadow-lg hover:shadow-xl transition mx-auto">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-col items-center mb-8">
                            ...
                            <span className="mt-3 text-[#F5E0D9] text-sm">Log in using your Google account</span>
                        </div>
                    </form>
                )}
            </div>
